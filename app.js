...
// }
// userName();
// console.log(`Are they accessible globally? Yes`);
...
// function exampleVar() {
//     if (true) {
//       var message = "This is function-scoped";
//     }
//     console.log(message); // Accessible here because `var` is not block-scoped
//   }
...
//     }
//     // console.log(i); // Uncommenting this line would cause an error because `i` is block-scoped
//   }
...
//     const person = { name: "Alice", age: 25 }; // Object reference
//     person.age = 26; // Allowed: modifying properties of an object
//     console.log(person);
  
//     // pi = 3.14; // Uncommenting this line would cause an error
//     // person = {}; // Uncommenting this line would also cause an error
//   }
...
// const firstName = "Suhaib";
// const lastName = "Ghori";
// console.log(`My name is ${firstName}  ${lastName}.`); // "My name is Suhaib Ghori."


// Multi-line Strings:
// const address = `Alsadaf Colony 
// Orangi Town Karachi`;
...
//   return `The result will be : ${num1*num2}`;
// }
// console.log(` ${greet(10,4)}`); 
